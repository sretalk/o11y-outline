...
要让业务系统的可观测性更好，通常需要建设观测系统，来存储业务系统对外暴露的各种数据，提供数据分析能力，从这点来看，观测系统和监控系统，值得做一些对比。
...
- 也会涉及采集和存储，主要是针对指标数据，而且指标去重之后的数量可枚举（相对较少）
...
整套体系非常庞大，如果从零建设并且每个方面都要做好，工作量会非常大，好在每个细分领域都有很多开源项目可以直接使用，大大降低了建设难度。下一节我们会介绍观测系统的建设路径。
